export const AUDIT_ACTIONS_V1 = [
  ...
  "EXTERNAL_APPLICATION_CREATED",
  "EXTERNAL_APPLICATION_STATUS_CHANGED",
  "EXTERNAL_APPLICATION_REMINDER_CHANGED",
  "INTERVIEW_PROPOSED",
  "INTERVIEW_RESPONDED",
  "INTERVIEW_RESCHEDULED",
  "INTERVIEW_CANCELLED",
  "INTERVIEW_REMINDER_PROCESSED",
  "MESSAGE_SENT",
