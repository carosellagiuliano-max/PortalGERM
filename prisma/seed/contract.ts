...
export const SEED_DATASET_VERSION = "phase-30-demo-v17" as const;
/**
...
/**
 * Exact active fixture contract. Phase 30 adds deterministic Freshness and
 * duplicate-fingerprint evidence for published demo jobs while all published
 * business counts remain sealed.
 */
