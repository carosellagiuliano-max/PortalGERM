...
const EXPECTED_PAGE_COUNT = 107;
const EXPECTED_HANDLER_COUNT = 17;
...
test.describe("Phase 18 exhaustive route quality", () => {
  ...
  test(
      `${QUALITY_TAGS} route inventory is exactly 107 pages, tracks 17 handlers and excludes handlers from page visits`,
    async ({ page }, testInfo) => {
