...
beforeAll(async () => {
  ...
  await pool.query(
    [
      ...
      '  "description", "severity", "status", "privacyEvidenceMode",',
      '  "privacyNoticeVersion", "privacyNoticeHash", "dueAt", "updatedAt"',
      ") VALUES (",
      "  $1, 'JOB', $2, $3, 'PUBLIC_VISIBILITY_REVIEW',",
      "  'Integration fixture for an effective visibility restriction.',",
      "  'HIGH', 'IN_REVIEW', 'LOCAL_SYNTHETIC', 'abuse-report-privacy-v1',",
