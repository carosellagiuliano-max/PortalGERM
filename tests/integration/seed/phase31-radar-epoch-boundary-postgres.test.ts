...
describe.sequential("Phase-31 Radar demo-seed epoch boundary regression", () => {
  it("keeps the legacy compatibility mapping outside the canonical Phase-14 epoch", async () => {
