...
- `STH-020`: Adminreads besitzen Caps 100–250; Fälle dahinter können
  unerreichbar werden.
- `STH-021`: Phase 27 hat die parallelen Einzeljob-Transaktionen durch einen
  bounded Detail-Batch in einem Eligibility-Snapshot ersetzt. Ein
  instrumentiertes Gesamt-Query-Count-/p95-Ceiling für 48 Kandidaten und
  Notification-Link-Autorisierung bleibt Track 30B.
