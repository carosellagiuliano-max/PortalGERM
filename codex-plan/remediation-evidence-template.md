...
| Planstatus | `PLANNED / READY / BLOCKED` |
| Technical Status | `NOT IMPLEMENTED / IMPLEMENTED` |
| Quality Status | `NOT RUN / FAILED / PASSED` |
| Activation Status | `DISABLED / SANDBOX / STAGING / LIVE` |
...
| G4 Release | Clean Clone, Full Suite, Provider-/Worker-/Failure-/Restore-Drills und manueller Rollen-Walkthrough auf gleichem Artefakt | `OFFEN / N/A nur wenn nicht Phase 32` | `OFFEN` |
...
Eine Phase darf erst `[x]` werden, wenn ihr Statusquartett, jede
zielklassenspezifische P0-Zeile, die vollständige AC-Matrix, der erforderliche
Gate-Lauf und alle externen Aktivierungsentscheidungen widerspruchsfrei sind.
