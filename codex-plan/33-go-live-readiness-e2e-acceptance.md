...
| Technikstatus | `PENDING` — Baseline/Audit und Remediation laufen; kein technischer Abschluss behauptet                                      |
| Quality-Gate  | `PENDING` — ein grüner älterer Lauf oder vorhandener Code ist keine Phase-33-Evidence                                        |
...
| Startbaseline | `59ed81033d409aac847c55f1da3ecf5370f4f035`; finaler Candidate und Artefaktdigests werden erst in der neuen Evidence gebunden |
...
Alle Zeilen sind zunächst `PLANNED`. Eine Testdatei oder ein Commandname ist
erst Evidence, wenn er existiert und auf dem finalen Candidate Exit `0`, Fail
`0`, unerklärte Skip `0` und Retry `0` liefert.
