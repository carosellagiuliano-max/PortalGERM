...
| Quality-Gate | `LOCAL G3 PASS` |
| Aktivierung | `DISABLED / SANDBOX / BLOCKED BY EXTERNAL GATE` |

Der strukturierte Company-Trust-V2-Vertrag ist auf Zielcommit
`96933aa330fe0a58c1fad7a238b523742f0ded67` lokal und in CI-Semantik
verifiziert; die Basisimplementierung liegt auf `e1a2e48`. Siehe
[Phase-26-Evidence](./evidence/2026-07-28-phase-26.md). Deterministische
Register-/Domain-Sandboxes sind ausdrücklich keine reale Provider-Evidence.
Für LC3–LC6 bleiben ein starkes öffentliches Badge, öffentliche
„verifizierte“ Stellen und Talent-Radar-Zugriff deaktiviert, bis Provider-,
Legal-, Reviewer-Capacity-, Staging- und Rollout-Gates separat freigegeben
sind.
...
- `STH-014` ist technisch geschlossen: Evidence, Providerchecks,
  Domain-Challenge, Decision, Projection, Appeal, Expiry und Re-review sind
  versioniert und strukturiert; Text-/Referenz-Legacy wird nicht zu starkem
  Trust hochgestuft.
- Submit/Review/Needs-info/Reject/Revoke-, Lock-, Supersession-,
  Notification- und Radar-Widerrufsketten arbeiten mit dem V2-Vertrag und
  Separation of Duties.
- Nachweisdokumente nutzen den Phase-21-Vault; Public DTOs enthalten weder
  Dokumentbytes/-keys noch Providerrohantworten, Challenge-Secrets oder
  Reviewer-Notizen.
- Company-, Job- und Radar-Konsumenten verwenden dasselbe aktuelle,
  fail-closed Trust-Read-Model. Expiry, Hold und Revoke wirken beim nächsten
  Read.
- Phase-25-Trust-&-Safety ist integriert; Restore verlangt frische starke
  Post-Incident-Evidence und einen unabhängigen Entscheider.
- Reale Register-/Domainprovider, Reviewerzeit, Staffing, Unit Cost,
  Provider-/Pager-Drills und Staging-Evidence fehlen weiterhin und blockieren
  jede öffentliche Aktivierung.
...
Alle Owning-Testdateien sind implementiert und liefen zusätzlich innerhalb der
vollständigen Unit-, PostgreSQL-, HTTP-, Desktop- und 360px-Gates. Exakte
Ergebnisse und externe Grenzen stehen in der
