...
> Tests, Release-Evidence und Runbooks. Dieses Dokument steuert die
> Implementierungen. Der ursprüngliche Phase-19-Anteil von `STH-029` ist auf
> Candidate `769ee62` geschlossen; seine Phase-33-Governance-Regression
> `F33-GOV-01/02` bleibt bis zum exact-candidate-G4 `TECHNICAL_BLOCKER`;
...
> offen. Die Phase-32-Evidence endet historisch `LC1 / NO_GO`; Phase 33 führt
> ohne neue `STH-*`-ID die technische LC4-/LC5-Closure über die vorhandenen
> Befunde aus. Dieses Dokument erteilt keine Go-live-Freigabe.
...
| STH-003 | CV nur als Metadaten, keine nutzbaren Bytes                                             | Phase-21-Sandbox technisch gelöst; Phase-33-S3-/Scanner-Closure `PENDING`, Aktivierung extern blockiert       | P0 vor realer Bewerbung                                                    | Dokumente/Storage        | 21/22; Closure 33            | 19/20, STH-004; Worker/Step-up 23/25                                                              | Quarantäne-first CV-Bytes, immutable Versionen, single-use Grants und Reconciliation historisch belegt; Phase 33 ergänzt authority-bound S3-/Scanner-/Privacy-Export-Code ohne Aktivierung          | historische Phase-21/22-Evidence `PASS`; Phase-33-Provider-/Contract-/G4-Nachweis ausstehend                                                        | [Phase-21-Evidence](./evidence/2026-07-26-phase-21.md); [Phase-22-Evidence](./evidence/2026-07-26-phase-22.md); `lib/providers/storage/**`                                                        | Storage/KMS/Scannerkonto, Region/DPA, Retention/Legal-Hold, Staging und Zielbetrieb                      |
| STH-004 | Produktive externe Provider fehlen                                                      | Phase-33-Live-Adaptercode im Arbeitsbaum; technische Closure `PENDING`, reale Aktivierung extern              | P0-Programm, je Provider separat                                           | Provider                 | 20/21/23/24; Closure 33      | 19 sowie Legal, Secrets, Monitoring                                                               | fail-closed authority-bound Resend-, S3-/ClamAV- und Stripe-Contract/Sandbox/Live-Composition; kein Secret-allein und kein Production→Mock-Fallback                                                 | gezielte Provider-/PG-Tests vorhanden; vollständiger exact-candidate-G4 und reale LIVE-Evidence ausstehend                                          | historische Phase-20/21/24-Evidence; [Phase-33-Vertrag](./33-go-live-readiness-e2e-acceptance.md); `lib/providers/**`                                                                             | Providerverträge, DPA/Region, DNS/Zugänge, Monitoring, Budget, Staging                                   |
| STH-005 | Keine reale Zahlung/Billing-Abwicklung                                                  | Phase-24-Sandbox technisch gelöst; Phase-33-LC5-Contract `PENDING`, Paid-Aktivierung extern blockiert         | P0 für Paid Self-Service                                                   | Billing/Finance          | 24/33                        | 19, STH-004, Worker, Tax/Legal, Phase-31A-Go/No-go                                                | authority-bound Hosted Checkout, signierte durable Inbox, Subscription/Invoice-Projektion, Reconciliation, Refund/Chargeback/Dunning und Recovery im Phase-33-Arbeitsbaum; LC4 Kaufpfad geschlossen | gezielte Unit-/PostgreSQL-/Contracttests einschließlich Hydration/Alias/Refund/Renewal vorhanden; vollständiger exact-candidate-G4 ausstehend       | [Phase-24-Evidence](./evidence/2026-07-27-phase-24.md); `lib/billing/payment-inbox.ts`; `lib/providers/payments/**`                                                                               | WTP-Go, PSP-Vertrag, Tax/Legal/Finance, Staging, Monitoring und Freigabe                                 |
| STH-006 | Kein realer Datenexport und keine reale Löschung                                        | Phase-22-Sandbox technisch gelöst; Phase-33-Approval-/Worker-Closure `PENDING`, Aktivierung extern blockiert  | P0                                                                         | Privacy/Legal            | 22/33                        | 19, STH-001/002, Storage, Worker und Phase-25-Step-up                                             | Inventory/Export/Correction/Erasure/Holds historisch; Phase 33 ergänzt persistente Dual-Approval→WorkItem→Worker→Artifact/Outbox-Kette und Candidate-artifact-bound Download                        | gezielte Unit-/PostgreSQL-/Contracttests vorhanden; Production-Contract-/exact-candidate-G4 ausstehend                                              | [Phase-22-Evidence](./evidence/2026-07-26-phase-22.md); `lib/privacy/**`; `tests/integration/privacy/phase33-*`                                                                                   | Counsel/Retention, Nicht-Kontoinhaber-Identity, Provider, DPA/Region und moderierte Forschung            |
...
| STH-008 | Produktionsbetrieb extern/offen                                                         | Phase-33-Production-Contract-Runtime im Arbeitsbaum; technische Closure `PENDING`, Zielbetrieb extern         | P0 Go-live-Gate                                                            | Operations/Release       | 23/33                        | 19, Infrastruktur, STH-004/009                                                                    | isolierte local/mock- und production-contract-Profile mit App/OCI, Worker, Scheduler, TLS, PG16, S3, Scanner, Stubs, Health und exact Artefaktvertrag; keine Deploymentwirkung                      | Runtime-/Recovery-/Artifacttests vorhanden; vollständiger exact-candidate-G4 und echte Staging-/Rollback-Evidence ausstehend                        | `compose.phase33.yml`; `scripts/phase33-*`; `lib/release/phase33-*`; Phase-33-Findings-Ledger                                                                                                     | Infrastruktur, Secrets, Pager/Owner, Backup-Lifecycle, genehmigte SLO/RPO/RTO, Staging                   |
| STH-009 | Kein autonomer Worker                                                                   | Phase-23 Local/CI technisch adressiert; Phase-33-Production-Contract `PENDING`, Production extern             | P0 für unbeaufsichtigten Self-Service                                      | Worker/Outbox/Ops        | 23/33                        | 19, STH-013, Monitoring                                                                           | gemeinsame Queue plus einheitlicher Worker-Service, Lease/Heartbeat/Fencing, authority-bound Generation/Effect Receipt, Retry/DLQ/Replay, Scheduler, Backpressure und Revoke-Barriere               | gezielte Unit-/PG-/Chaos-/Benchmarktests vorhanden; finaler Candidate-G4/Staging/Pager offen                                                        | `lib/ops/worker-*.ts`; `lib/ops/registered-handler-runtime.ts`; `scripts/phase23-worker.ts`; Worker-Operations-Runbook                                                                            | Workerhosting, Monitoring/Pager/On-call, SLO-Freigabe, Zielumgebungsdrill                                |
...
| STH-013 | Kein dauerhafter E-Mail-Outbox-/Retry-Vertrag                                           | Phase-20/23 Local/CI technisch gelöst; Phase-33-Live-/Worker-Closure `PENDING`                                | P0                                                                         | E-Mail/Worker            | 20/23/33                     | 19, STH-004/009                                                                                   | atomare Outbox, Attempts, Lease/Heartbeat, Retry/Suppression/DLQ historisch; Phase 33 ergänzt use-case-/authority-bound Resend, durable Event-Inbox, Legacy-Mock-Denial und Backlog-Readiness       | historische Evidence `PASS`; neue Provider-/Inbox-/Worker-Tests vorhanden, finaler exact-candidate-G4 ausstehend                                    | [Phase-20-Evidence](./evidence/2026-07-26-phase-20.md); `lib/notifications/**`; `lib/providers/email/**`                                                                                          | Zustellprovider, DNS/DPA, Monitoring/Pager, Staging und reale Receipts                                   |
...
| STH-018 | Marketplace-Liquidität unbewiesen                                                       | technische Cluster-/Releasebasis gelöst; reale Marktentscheidung offen                                        | P0 Markt-Gate                                                              | Marketplace/Go-to-market | 31                           | 19, reale Kohorten/Analytics und STH-019-Evidence je Startcluster                                 | Phase-31-Releasebindung, Append-only-Evidence und DB-Backstop erlauben genau einen ersten öffentlichen Cluster; ohne LIVE-Evidence bleibt Aktivierung 0                                             | Unit/PostgreSQL/Concurrency/V1-/Digest-/Approval-Negativmatrix `PASS`; reale Liquidität und Fachentscheid fehlen                                    | [Phase-31-Evidence](./evidence/2026-07-30-phase-31.md); `lib/commercial/cluster-gates.ts`; `prisma/migrations/20260730120000_phase_31_commercial_validation/migration.sql`                        | reale Arbeitgeber/Kandidaten/Jobs/Responses, Fachreviews und Product-/Ops-Entscheid                      |
| STH-019 | Startcluster-Suche ohne gemeinsamen Berufs-/Ort-/Qualifikations-/Skill-/Branchenvertrag | technische Basis gelöst; Fachreview und Clusteraktivierung offen                                              | P0 je aktivem LC3+-Cluster; P1 Design Partner, P2 Demo                     | Search                   | 30A                          | 19, versionierte Taxonomie, Pflege-/Engineering-Korpus, Golden-/Negativkorpus und Clusterfreigabe | gemeinsamer de-CH-Concept-/Releasevertrag für sechs Dimensionen, Search, Alert, Recommendations, Matching, Cursor und Cluster V2; Pflege `SELECTED/NOT_REVIEWED`, Engineering `DISCOVERY_ONLY`      | Golden-/Negative-, Dimension-, PostgreSQL-Paritäts-, Cursor-, Cluster-V2- und globale Search-Regression `PASS`; Fachreview/50k-Target-Harness offen | [Phase-30-Evidence](./evidence/2026-07-29-phase-30.md); `lib/search/concepts-v2.ts`; `lib/jobs/public-read-model.ts`; `lib/candidate/job-alerts.ts`; `lib/candidate/recommendation-read-model.ts` | signiertes Pflegefachreview des exakten Digests; Zielumgebungs-Shadow/Load                               |
| STH-020 | Admin-Queues mit harten Caps                                                            | bestätigt; unter dokumentiertem Trigger überwacht/deferred                                                    | P1 vor hohem Betriebsvolumen                                               | Admin Operations/Scale   | 30B                          | 19, STH-010, Cursor-/Indexvertrag                                                                 | bestehende Caps bleiben unter der lokalen Baseline; gemeinsame Triggerpolicy eskaliert ab 70 %, p95/Forecast oder Cap; Pagination/Bulk wird erst dann queueweise gebaut                             | Trigger-Unitvertrag `PASS`; Phase-19-DEMO-Maximum 115/250 und kein aktueller Zieltrigger; >250-/Bulk-Suite bewusst nicht vorgetäuscht               | [Phase-30-Evidence](./evidence/2026-07-29-phase-30.md); `lib/ops/phase30-scale-trigger.ts`; [Phase-30-Runbook](./runbooks/phase30-search-freshness-operations.md)                                 | datierte Zielumgebungs-Queue-/p95-/Forecastmessung und Alertowner                                        |
| STH-021 | Dashboard-Empfehlungen mit Query-Fan-out                                                | technisch gelöst für den ausgelösten Recommendation-Track                                                     | P1 Performance                                                             | Candidate/DB Scale       | 27 Mitigation; 30B Abschluss | 19, Batch-Read-/Rankingvertrag                                                                    | der >20-Query-Trigger wurde durch den 42-Query-Istwert ausgelöst; eine bounded Zwei-Query-Projektion filtert canonical Eligibility/Trust vor der Dashboardbewertung                                 | 48-Job-Instrumentierung `PASS`: Querycount 2 ≤8, p95 ≤300 ms, drei Freshness-/Trust-Canaries 0; volle Candidate-/Browserregression                  | [Phase-30-Evidence](./evidence/2026-07-29-phase-30.md); `lib/candidate/recommendation-read-model.ts`; `tests/integration/candidate/phase30-recommendations-postgres.test.ts`                      | Zielumgebungs-SLO/Alert bleibt Releasegate                                                               |
| STH-022 | Business/Enterprise nur eingeschränkt lieferbar                                         | betreuter Draft-only-Import technisch gelöst und deaktiviert; breite Integrationen offen                      | P1 nach WTP, XL je Integration                                             | Monetization/Enterprise  | 31                           | 19, STH-004/009/024, Marktvalidierung                                                             | Source Rights→Mapping→Preview→explizite Bestätigung→Draft-only Commit mit Tenant-/Digest-Recheck; recurring Sync, Auto-Publish, ATS/API/SSO nicht verkauft                                          | Unit/PostgreSQL/Browser `PASS`; Foreign Tenant, stale Digest/Recht, Replay und disabled Gate erzeugen 0 unzulässige Writes                          | [Phase-31-Evidence](./evidence/2026-07-30-phase-31.md); `lib/commercial/managed-import-service.ts`; `/employers/xml-import`                                                                       | Design-Partner, reale Source Rights, SLA/DPA, Integrationszugänge und Aktivierungsentscheid              |
...
| STH-024 | Manueller Walkthrough nicht auf aktuellem Release-Commit                                | bestätigt; Phase 32 bleibt `NO_GO`, Phase-33-Candidate/G4 einschließlich lokalem Rollen-Walkthrough `PENDING` | P0 Release-Gate                                                            | Release Evidence         | 32 historisch / 33 Technik   | alle Remediation-Phasen, sauberer Candidate und identisches Artefakt                              | Automation plus lokaler Vier-Rollen-/Desktop-/360/320-/Keyboard-/Semantik-Walkthrough auf demselben Phase-33-Candidate; echte AT-Geräte, Zieldeployment und unabhängige Approvals bleiben extern    | kein Phase-33-Gesamtclaim vor unverändertem Candidate, 38/38 Commands, Retry/Skip 0 und dokumentiertem manuellen Ablauf                             | [Phase-32-Evidence](./evidence/2026-07-30-phase-32.md); [Phase-33-Vertrag](./33-go-live-readiness-e2e-acceptance.md)                                                                              | Staging/Release-Artefakt, NVDA/VoiceOver-Geräte, unabhängige Tester und Approvals                        |
...
| STH-027 | Einzelne Sitemap stoppt bei 50.000 URLs                                                 | Monitor technisch gelöst; Shards unter Trigger korrekt deferred                                               | P3 kapazitätsabhängige Skalierung; Eskalation nur nach Mess-/Forecast-Gate | SEO/Scale                | 30C                          | 19, LIVE-Count-/Byte-/Wachstumsbaseline und Monitoring; Shardstrategie erst bei Trigger           | registrierter Tageshandler persistiert append-only Count, Bytes, Runtime, Erfolg, Wachstum, 90-Tage-Forecast, 70/80/90-Zustand und Owner; Single-Sitemap bleibt fail-closed/no-truncation           | Unit-/PostgreSQL-/Worker-/Sitemapregression `PASS`; Phase-19-Baseline 10/50.000 URLs; Zielalertreceipt offen, kein Shardtest unter Trigger          | [Phase-30-Evidence](./evidence/2026-07-29-phase-30.md); `lib/seo/sitemap-capacity-monitor.ts`; [Phase-30-Runbook](./runbooks/phase30-search-freshness-operations.md)                              | reale Zielumgebung, Search Console, Alertreceipt/Ops Owner; Shards nur bei Trigger                       |
| STH-028 | Demo-/Preis-Copy nennt Hypothesen                                                       | technisch geschützt und weiterhin korrekt; Production nicht freigegeben                                       | Schutz-Gate, kein Defect-Prioritätswert                                    | Commercial Copy          | 31                           | STH-005/007/018/022, WTP/Legal                                                                    | Research-/Production-Copy folgt demselben fail-closed Releasevertrag; ohne 31A-/Delivery-/Capacity-/Policy-Evidence erscheinen keine öffentliche Kauf-CTA oder Produktivbehauptung                  | Unit/Browser/Desktop/Mobile `PASS`; Demo/Test/Lead werden ausdrücklich nicht als WTP bezeichnet                                                     | [Phase-31-Evidence](./evidence/2026-07-30-phase-31.md); `lib/commercial/production-offer.ts`; `app/(public)/pricing/page.tsx`                                                                     | echter Net-Geldtest plus Delivery, Legal/Tax, freigegebener Katalog und Zielumgebung                     |
...
> Der ursprüngliche Phase-19-Anteil von `STH-029` ist auf `769ee62`
> geschlossen; die additive Phase-33-Regression bleibt bis zum vollständigen
> G0/G4-Nachweis `TECHNICAL_BLOCKER`. `STH-001`, `STH-002` und
...
| --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `STH-029` | **Phase-19-Basis geschlossen; Phase-33-Regression offen:** höher priorisierte Requirements, Architektur, ADRs, Implementation Guidance, Quickref/Glossary und Phasen 19–32 waren nicht synchron; Candidate `769ee62` versiegelte den ursprünglichen Vertrag. Phase 33 erweitert ihn ohne rückwirkende Evidenceänderung auf die technische Abschlussphase; dieser additive Nachweis ist noch nicht abgeschlossen. | 19 historisch abgeschlossen / 33 `IN_PROGRESS` | Product, Engineering, QA; `00-PLAN.md`, `requirements-matrix.md`, `architecture-blueprint.md`, `decisions.md`, `implementation-plan.md`, Phase-19–33-Testabschnitte                    | Candidate `769ee62`; Phasen 01–18/Evidence immutable; Ist-Routeinventar nicht vorplanen; exact-candidate-G4 ausstehend                | 37/37 IDs, sechs LC, vier Statusdimensionen, jede Phase 28 Punkte und vollständige AC-Matrix; Phase 33 zusätzlich 17 ACs, Findings Ledger und G4-Technikcandidate                                         | kein externes Fachgate; Phase-33-Anteil `TECHNICAL_BLOCKER` über `F33-GOV-01/02` bis finalem G0/G4                                                                                 |
...
| `STH-032` | **technisch gelöst, Aktivierung offen:** `JOB_FRESHNESS_POLICY_V1`, additive Bestandscohort, Reminder, versionierte Reconfirmation, Filled, Candidate-Report mit vierstündigem fail-closed Hold, Exact-/Near-Duplicate und zentrale Consumer-Eligibility sind implementiert.                                                                                                                                     | 30D / 23 Worker, 26 Trust, 31 Cluster          | Visitor, Candidate, Employer, Admin; Public Search/Detail, Employer Jobs, Admin Queue; `lib/jobs/freshness.ts`, `lib/jobs/public-eligibility.ts`, Alerts/Sitemap/Recommendations       | 23 Notifications/Worker und 26 Trust; bestehende Publish-/Revision-/Quota-/Slug-/Boost-/Eligibility-Verträge                          | Unit/PostgreSQL/Concurrency/Abuse/Consumer-Diff/Chromium und Vollregression `PASS`; stale/filled/held/duplicate erzeugen keine neue Public-/Alert-/Recommendation-/Sitemapwirkung                         | [Phase-30-Evidence](./evidence/2026-07-29-phase-30.md); fachliche Policy technisch fest, reale vierstündige Moderationskapazität, Pager, Staging und Public-Go **offen**           |
...
| `STH-034` | **technische Modellbasis gelöst, reale Werte offen:** `CapacityModelRelease` und `CashflowModelRelease` versionieren Arrival, Handling Time, Backlog, Staffing/Coverage, Utilization, Unit Cost, Concierge-Cap sowie 18/24-Monats-Cash-in/-out ohne Invoice-/CAC-Doppelzählung.                                                                                                                                  | 31A fachlich / 23 Telemetrie, 25/26/30 Queues  | Ops, Support, Privacy, Trust, Commercial/Finance; `lib/commercial/capacity-model.ts`, `lib/commercial/cashflow.ts`, additive Phase-31-Persistenz                                       | reale oder kontrolliert gemessene Fälle; STH-033 Research; Demo-Zeitwerte und Fixturemodelle zählen nicht als Marktbeleg              | Unit-/PostgreSQL-/Immutable-Release-Vertrag `PASS`; >80 % Utilization, SLA-/COGS-/Runwaybruch sperren Release fail-closed; echte Messquellen und Ownerapproval fehlen                                     | [Phase-31-Evidence](./evidence/2026-07-30-phase-31.md); Staffing-/Kosten-/Servicelevel-/Finance-Freigabe und reale Kalibrierung **offen**                                          |
| `STH-035` | **technisch Local/CI gelöst:** Phase 31 ergänzt Phase 24 um einen versionierten kundensichtbaren `ServicePolicyRelease` und eine exactly-once Remedy-/SLA-/Eskalationsmatrix. Plattformfehler bleiben von Outcome-, User- und Providerfehlern getrennt; Ledger/Invoice/Order bleiben immutable.                                                                                                                  | 31 technisch / 24 Finance, 26 Trust            | Employer Owner, Finance, Support, System; `lib/commercial/paid-service-recovery-policy.ts`, `lib/billing/service-delivery-policy.ts`, `lib/billing/finance-operations.ts`              | WTP-Go, echte Zahlung, Trust-/Provider-Failureklassifikation; technische Recovery darf kein unfreigegebenes Paid-Versprechen erzeugen | Unit/PostgreSQL/Replay/Parallelität und Browservertrag Local/CI `PASS`; konkrete Finance-/Legal-/Support-Freigabe und LIVE-Incident bleiben extern                                                        | [Phase-31-Evidence](./evidence/2026-07-30-phase-31.md); [Phase-24-Evidence](./evidence/2026-07-27-phase-24.md); Paid-Versprechen und Zielumgebung **offen**                        |
| `STH-036` | **technische Privacy-Basis gelöst, Collection deaktiviert:** Request-lokale Query, PII-/Secret-Reject, purpose-separierte HMAC-Token-/Contributorbucket, allowlisted Filterfingerprint, `k=10`, 30-Tage-Working-State und capability-gebundener Review→Promote/Reject→Expiry-/Audit-Lifecycle sind implementiert; keine Rohqueryspalte existiert.                                                                | 30A / Privacy 22, Fachreview 31A               | Visitor/Candidate, Search/Data/Privacy; `app/(public)/jobs/actions.ts`, `lib/search/learning.ts`, `lib/admin/search-learning.ts`, `/admin/taxonomy`                                    | STH-017 Analytics/Consent und STH-019 Taxonomie; Collection default-off und eigener Base64-Secret-Vertrag                             | PostgreSQL k=9/10, Contributor-Dedupe, PII/Secret-Canary, TTL, Review/Promote/Reject/Replay/Audit sowie Unit-/Securityregression `PASS`; kein automatisches Taxonomiepublish                              | [Phase-30-Evidence](./evidence/2026-07-29-phase-30.md); Privacy-/Data-/Fachfreigabe, Zielvolume/Poisoning-Monitor und LIVE-Collection **offen**                                    |
| `STH-037` | **technische Reihenfolgenlücke gelöst, Marktbeweis offen:** Kernworkflow, Hiring Sprint, Retainer, Concierge und betreuter Import müssen vor Boost/Radar freigegeben sein; die Datenbank erlaubt genau einen ersten öffentlichen Cluster. Boost braucht organische LIVE-Reichweite, Radar LIVE-Dichte/Funnel/Privacy.                                                                                            | 31A extern / 24, 26, 30A; 31B Technik          | KMU, Product, Commercial, Finance; `lib/commercial/offer-sequencing.ts`, `lib/commercial/addon-gates.ts`, `CommercialOfferRelease`                                                     | Phase 19; fachliches Korpus, reale WTP-/Delivery-, Cashflow-/Capacity-Evidence; Paid Self-Service Phase 24 erst nach Go               | Unit/PostgreSQL/Concurrency/Browser `PASS`; Mock/Test/Free/LOI/Lead/Selbstkauf/refunded/null Delivery zählen 0; Add-on-first und zweiter erster Cluster erzeugen 0 Freigabe                               | [Phase-31-Evidence](./evidence/2026-07-30-phase-31.md); reale KMU, Net-Geld plus Delivery, Tax/Legal/AVG/Finance **offen, keine WTP-Behauptung**                                   |
...
## 3C. Phase-33-Overlay für technische LC4-/LC5-Closure

Phase 33 führt keine neue `STH-*`-ID ein. Sie regressiert und schließt
vorhandene technische Findinganteile auf einem neuen Candidate; die fachlichen Owner und
historischen Evidence-Records bleiben unverändert. Das laufende Detailledger
steht in [phase33-findings-ledger.md](./phase33-findings-ledger.md).

| Finding   | Phase-33-Anteil                                                                                                                           | LC4 / LC5 | Technischer Abschlussweg                                                                  | Aktivierungsgrenze                                                             |
| --------- | ----------------------------------------------------------------------------------------------------------------------------------------- | --------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| `STH-003` | S3-/Scanner-Live-Adaptercode oder vollständige serverseitige Entfernung der Vault-/Exportfunktion aus dem Scope                           | P0* / P0* | Storage-/Scanner-Contract, Quarantäne, Malware/MIME/Hash/Timeout, IDOR und Reconciliation | Region/DPA/KMS/Scannerkonto und Retention/Legal-Hold extern                    |
| `STH-004` | E-Mail-, Storage-/Scanner- und Payment-Composition mit Environment × Use Case × Adapter × Version × Mode und null Production-Mockfallback | P0\* / P0 | Unit-/PostgreSQL-Ledgermatrix und echte Adaptercode-Contracts gegen isolierte Stubs       | Providerkonto, DNS, Vertrag, DPA, Budget, Monitoring und Staging extern        |
| `STH-005` | LC4 Kaufpfad vollständig geschlossen; LC5 Checkout/Webhook/Projection/Reconciliation/Dunning/Refund technisch konfigurierbar              | P4 / P0   | Payment-Contract-/PostgreSQL-/E2E-Matrix mit Mode/Account/Signatur/Replay/Out-of-order    | WTP, PSP, Tax/Legal/Finance und reale Paymentreceipts extern                   |
| `STH-006` | Export-/Erasure-/Processorpfad gegen Production-Contract-Storage/Worker regressieren                                                      | P0 / P0   | Export/Correction/Erasure, Partial Failure, Resume, Reconciliation, Restore und PII-Scan  | Counsel, Nicht-Kontoinhaber-Identity, Processor und Retention extern           |
| `STH-008` | gepinnte isolierte Runtime mit Standalone/OCI-App, TLS, PostgreSQL 16, Worker, Scheduler, Storage/Scanner/Stubs und Healthchecks          | P0 / P0   | `local/mock`- und `production-contract`-Composeprofile plus Recovery-/Artefaktdigests     | echter Host, Secrets, Monitor, Pager, Backup/Restore und Staging extern        |
| `STH-009` | autonomer Worker-/Schedulerprozess im Production-Contract inklusive Crash/Lease/DLQ/Replay/Provideroutage                                 | P0 / P0   | Chaos, 10.000×4 Benchmark, Restart/Rolling Deploy und exactly-once Domainwirkung          | Workerhosting, On-call, genehmigte SLO/Capacity extern                         |
| `STH-013` | Notification-Outbox über denselben Live-E-Mail-Adaptercode mit getrennten Delivery-AES-/Recipient-HMAC-Keyrings, API-/Webhook-Secret-Versionen und providerunabhängiger Retention vollständig ausführen | P0 / P0 | accepted/duplicate/bounce/429/500/network/408/malformed-2xx/concurrent-idempotency; bounded Same-Key-Retry→`PAUSED`/manuelle Reconciliation; 23 h/31 d/exakt `400 × 24 h`, Key-Version-Inventar, Activation-TX-Lock und monotone Inbox/Suppression ohne Verlust, Blind-Resend oder Falschclaim | Absenderdomain, Provider/DPA, Privacy-/Legal-/AVG-/SECO-Retentionfreigabe, Monitoring, Staging und echte Zustellbarkeit extern |
| `STH-023` | vollständiger Candidate über drei Engines, Desktop/360/320, Keyboard/Fokus/Zoom/Reduced Motion/Axe                                        | P0 / P0   | Retry 0, Console-/Network-/Overflow-/Axe-critical/serious 0                               | reale NVDA-/VoiceOver-/Research-Evidence bleibt extern                         |
| `STH-024` | kompletter Public-/Candidate-/Employer-/Recruiter-/Admin-/Ops-Walkthrough und Automation auf demselben neuen Candidate/Artefakt           | P0 / P0   | Phase-33-Full Gate, Rollen-/Journey-/Failurematrix und Digestbindung                      | tatsächliches Deployment, unabhängige Tester/Approvals und Zielrollback extern |

Die Phase-33-Ausführungs-Requirements `REQ-INT-033-001`,
`REQ-OPS-033-001`, `REQ-QA-033-001` und `REQ-REL-033-001` instanziieren diese
Zeilen. Technische Readiness darf nur auf `CLOSED`-/sicher `DISABLED`-/
begründet `DEFERRED_MONITORED`-Zeilen beruhen; `EXTERNAL` bleibt ein separates
Aktivierungsurteil und darf keinen repository-internen Restdefekt verdecken.
...
- Phase 19 `19-remediation-baseline-regression.md` rebaselined alle 37 IDs und
  ...
  Querschnittsabhängigkeit. Phase 33 ist nur technischer Closure-/Regression-
  Owner für den in §3C genannten Anteil und übernimmt keinen fachlichen Owner.
