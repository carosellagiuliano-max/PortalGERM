...
> `F33-GOV-01/02` ist nach exact-candidate-G4 `CLOSED`;
...
| STH-003 | CV nur als Metadaten, keine nutzbaren Bytes                                             | Phase-21-Sandbox technisch gelöst; Phase-33-S3-/Scanner-Closure `PASSED`, Aktivierung extern blockiert       | P0 vor realer Bewerbung                                                    | Dokumente/Storage        | 21/22; Closure 33            | 19/20, STH-004; Worker/Step-up 23/25                                                              | Quarantäne-first CV-Bytes, immutable Versionen, single-use Grants und Reconciliation historisch belegt; Phase 33 ergänzt authority-bound S3-/Scanner-/Privacy-Export-Code ohne Aktivierung          | historische Phase-21/22-Evidence `PASS`; Phase-33-Provider-/Contract-/G4-Nachweis `PASS`                                                        | [Phase-21-Evidence](./evidence/2026-07-26-phase-21.md); [Phase-22-Evidence](./evidence/2026-07-26-phase-22.md); `lib/providers/storage/**`                                                        | Storage/KMS/Scannerkonto, Region/DPA, Retention/Legal-Hold, Staging und Zielbetrieb                      |
| STH-004 | Produktive externe Provider fehlen                                                      | Phase-33-Live-Adaptercode im Arbeitsbaum; technische Closure `PASSED`, reale Aktivierung extern              | P0-Programm, je Provider separat                                           | Provider                 | 20/21/23/24; Closure 33      | 19 sowie Legal, Secrets, Monitoring                                                               | fail-closed authority-bound Resend-, S3-/ClamAV- und Stripe-Contract/Sandbox/Live-Composition; kein Secret-allein und kein Production→Mock-Fallback                                                 | gezielte Provider-/PG-Tests vorhanden; exact-candidate-G4 `PASS`; reale LIVE-Evidence ausstehend                                          | historische Phase-20/21/24-Evidence; [Phase-33-Vertrag](./33-go-live-readiness-e2e-acceptance.md); `lib/providers/**`                                                                             | Providerverträge, DPA/Region, DNS/Zugänge, Monitoring, Budget, Staging                                   |
| STH-005 | Keine reale Zahlung/Billing-Abwicklung                                                  | Phase-24-Sandbox technisch gelöst; Phase-33-LC5-Contract `PASSED`, Paid-Aktivierung extern blockiert         | P0 für Paid Self-Service                                                   | Billing/Finance          | 24/33                        | 19, STH-004, Worker, Tax/Legal, Phase-31A-Go/No-go                                                | authority-bound Hosted Checkout, signierte durable Inbox, Subscription/Invoice-Projektion, Reconciliation, Refund/Chargeback/Dunning und Recovery im Phase-33-Arbeitsbaum; LC4 Kaufpfad geschlossen | gezielte Unit-/PostgreSQL-/Contracttests einschließlich Hydration/Alias/Refund/Renewal vorhanden; exact-candidate-G4 `PASS`       | [Phase-24-Evidence](./evidence/2026-07-27-phase-24.md); `lib/billing/payment-inbox.ts`; `lib/providers/payments/**`                                                                               | WTP-Go, PSP-Vertrag, Tax/Legal/Finance, Staging, Monitoring und Freigabe                                 |
| STH-006 | Kein realer Datenexport und keine reale Löschung                                        | Phase-22-Sandbox technisch gelöst; Phase-33-Approval-/Worker-Closure `PASSED`, Aktivierung extern blockiert  | P0                                                                         | Privacy/Legal            | 22/33                        | 19, STH-001/002, Storage, Worker und Phase-25-Step-up                                             | Inventory/Export/Correction/Erasure/Holds historisch; Phase 33 ergänzt persistente Dual-Approval→WorkItem→Worker→Artifact/Outbox-Kette und Candidate-artifact-bound Download                        | gezielte Unit-/PostgreSQL-/Contracttests vorhanden; Production-Contract-/exact-candidate-G4 `PASS`                                              | [Phase-22-Evidence](./evidence/2026-07-26-phase-22.md); `lib/privacy/**`; `tests/integration/privacy/phase33-*`                                                                                   | Counsel/Retention, Nicht-Kontoinhaber-Identity, Provider, DPA/Region und moderierte Forschung            |
...
| STH-008 | Produktionsbetrieb extern/offen                                                         | Phase-33-Production-Contract-Runtime im Arbeitsbaum; technische Closure `PASSED`, Zielbetrieb extern         | P0 Go-live-Gate                                                            | Operations/Release       | 23/33                        | 19, Infrastruktur, STH-004/009                                                                    | isolierte local/mock- und production-contract-Profile mit App/OCI, Worker, Scheduler, TLS, PG16, S3, Scanner, Stubs, Health und exact Artefaktvertrag; keine Deploymentwirkung                      | Runtime-/Recovery-/Artifacttests vorhanden; exact-candidate-G4 `PASS`; echte Staging-/Rollback-Evidence ausstehend                        | `compose.phase33.yml`; `scripts/phase33-*`; `lib/release/phase33-*`; Phase-33-Findings-Ledger                                                                                                     | Infrastruktur, Secrets, Pager/Owner, Backup-Lifecycle, genehmigte SLO/RPO/RTO, Staging                   |
| STH-009 | Kein autonomer Worker                                                                   | Phase-23 Local/CI technisch adressiert; Phase-33-Production-Contract `PASSED`, Production extern             | P0 für unbeaufsichtigten Self-Service                                      | Worker/Outbox/Ops        | 23/33                        | 19, STH-013, Monitoring                                                                           | gemeinsame Queue plus einheitlicher Worker-Service, Lease/Heartbeat/Fencing, authority-bound Generation/Effect Receipt, Retry/DLQ/Replay, Scheduler, Backpressure und Revoke-Barriere               | gezielte Unit-/PG-/Chaos-/Benchmarktests vorhanden; Candidate-G4 `PASS`; Staging/Pager offen                                                        | `lib/ops/worker-*.ts`; `lib/ops/registered-handler-runtime.ts`; `scripts/phase23-worker.ts`; Worker-Operations-Runbook                                                                            | Workerhosting, Monitoring/Pager/On-call, SLO-Freigabe, Zielumgebungsdrill                                |
...
| STH-013 | Kein dauerhafter E-Mail-Outbox-/Retry-Vertrag                                           | Phase-20/23 Local/CI technisch gelöst; Phase-33-Live-/Worker-Closure `PASSED`                                | P0                                                                         | E-Mail/Worker            | 20/23/33                     | 19, STH-004/009                                                                                   | atomare Outbox, Attempts, Lease/Heartbeat, Retry/Suppression/DLQ historisch; Phase 33 ergänzt use-case-/authority-bound Resend, durable Event-Inbox, Legacy-Mock-Denial und Backlog-Readiness       | historische Evidence `PASS`; neue Provider-/Inbox-/Worker-Tests vorhanden, exact-candidate-G4 `PASS`                                    | [Phase-20-Evidence](./evidence/2026-07-26-phase-20.md); `lib/notifications/**`; `lib/providers/email/**`                                                                                          | Zustellprovider, DNS/DPA, Monitoring/Pager, Staging und reale Receipts                                   |
...
| STH-024 | Manueller Walkthrough nicht auf aktuellem Release-Commit                                | bestätigt; Phase 32 bleibt `NO_GO`, Phase-33-Candidate/G4 einschließlich automatisierter Rollenreisen `PASSED` | P0 Release-Gate                                                            | Release Evidence         | 32 historisch / 33 Technik   | alle Remediation-Phasen, sauberer Candidate und identisches Artefakt                              | Automation plus lokaler Vier-Rollen-/Desktop-/360/320-/Keyboard-/Semantik-Walkthrough auf demselben Phase-33-Candidate; echte AT-Geräte, Zieldeployment und unabhängige Approvals bleiben extern    | Phase-33-Technikclaim auf unverändertem Candidate mit 38/38 Commands und Retry/Skip 0 belegt; echter AT-Geräte-/Staging-Walkthrough bleibt extern                             | [Phase-32-Evidence](./evidence/2026-07-30-phase-32.md); [Phase-33-Vertrag](./33-go-live-readiness-e2e-acceptance.md)                                                                              | Staging/Release-Artefakt, NVDA/VoiceOver-Geräte, unabhängige Tester und Approvals                        |
...
> geschlossen; die additive Phase-33-Regression ist nach vollständigem
> G0/G4-Nachweis `CLOSED`. `STH-001`, `STH-002` und
