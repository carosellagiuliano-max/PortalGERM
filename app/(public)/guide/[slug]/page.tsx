...
export async function generateMetadata({ params }: GuidePageProps): Promise<Metadata> {
  ...
  if (guide === null) return { title: "Ratgeber nicht gefunden", robots: { index: false, follow: true } };
  return {
    title: guide.title,
