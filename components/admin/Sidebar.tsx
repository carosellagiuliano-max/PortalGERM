...
export const ADMIN_NAVIGATION: readonly PrivateNavigationItem[] = Object.freeze(
  [
    ...
    { href: "/admin/taxonomy", label: "Taxonomie" },
    { href: "/admin/reports", label: "Reports" },
    { href: "/admin/privacy-requests", label: "Datenschutzfälle" },
    { href: "/admin/legal", label: "Legal & Gates" },
    { href: "/admin/imports", label: "Importe" },
    { href: "/admin/support", label: "Support" },
    { href: "/admin/content", label: "Content" },
    { href: "/admin/leads", label: "Leads" },
    { href: "/admin/billing", label: "Billing" },
    { href: "/admin/finance/reconciliation", label: "Finance Ops" },
    { href: "/admin/plans", label: "Pläne" },
    { href: "/admin/products", label: "Produkte" },
    { href: "/admin/analytics", label: "Analytics" },
    { href: "/admin/business-cockpit", label: "Business Cockpit" },
